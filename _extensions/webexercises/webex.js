/* PURPOSE: bind the webexercises widgets -- fill-in-the-blank, select, radio, checkbox, the
 *   hidden-solution toggle and the check/try-again cycle -- to the markup the R functions write.
